...
/*   Updated: 2023/03/28 07:06:00 by htsang           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	triangle_maker->last_formula_executed = &triangle_maker_formula_front2;
...
t_push_swap_triangle_maker *triangle_maker, t_push_swap_instructor *instructor)
{
	triangle_maker->last_formula_executed = &triangle_maker_formula_front1rear1;
	if (stack_get_element_by_index(&triangle_maker->emulation.stack_a, 0) > \
		stack_get_element_by_index(&triangle_maker->emulation.stack_a, -1))
	{
		return (emulated_instructor_add_formula(triangle_maker, instructor, \
...
t_push_swap_triangle_maker *triangle_maker, t_push_swap_instructor *instructor)
{
	...
	triangle_maker->last_formula_executed = &triangle_maker_formula_rear1;
	return (emulated_instructor_add_formula(triangle_maker, instructor, \
...
t_push_swap_triangle_maker *triangle_maker, t_push_swap_instructor *instructor)
{
	...
	if (triangle_maker_formula_rear1(triangle_maker, instructor))
		return (FAILURE);
	return (triangle_maker_formula_rear1(triangle_maker, instructor));
}
